...
public class ProbePaintTanks {
  public static void main(String[] args) throws Exception {
...

    {
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P1, Velocity.NORMAL, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P1, Velocity.NORMAL, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P2, Velocity.NORMAL, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P2, Velocity.NORMAL, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P3, Velocity.NORMAL, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P3, Velocity.NORMAL, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P4, Velocity.NORMAL, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P4, Velocity.NORMAL, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P1, Velocity.FAST, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P1, Velocity.FAST, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P2, Velocity.FAST, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P2, Velocity.FAST, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P3, Velocity.FAST, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P3, Velocity.FAST, true), x0 + w * 7, y, null);
      ...
      g.drawImage(im.tank(Dir.RIGHT, Power.P4, Velocity.FAST, false), x0 + w * 6, y, null);
      g.drawImage(im.tank(Dir.RIGHT, Power.P4, Velocity.FAST, true), x0 + w * 7, y, null);
